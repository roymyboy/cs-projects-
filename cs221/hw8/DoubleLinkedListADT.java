...
/**
 * Adds requirement that the list supports a java.util.ListIterator to an
 * IndexedUnorderedList
 * 
 * @author Java Foundations
 * @version 4.0
 * @author mvail
 */
public interface DoubleLinkedListADT<T> extends IndexedUnorderedListADT<T> {
	/**
